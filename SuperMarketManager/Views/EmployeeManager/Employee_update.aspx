<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_update.aspx.cs" Inherits="SuperMarketManager.Views.EmployeeManager.Employee_update" %>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">员工管理-修改员工信息</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">员工管理-修改员工信息</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                                       ...
                                       <form action="#" class="form-horizontal" runat="server">
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">工号</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" id="id" runat="server" placeholder="员工工号" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
