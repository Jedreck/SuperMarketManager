                ...
                <div class="topbar-main">
                    ...
                    <ul class="nav navbar navbar-top-links navbar-right mbn">
                        ...
                        <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle">
                            <img src="../../Content/images/avatar/48.jpg" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">仓库管理员</span>&nbsp;<span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-user pull-right">
                                <li><a href="../../Views/PSInfo/PSInfo.aspx"><i class="fa fa-user"></i>个人信息</a></li>
                                <li><a href="../../Views/StoreManage/store.aspx"></i>我的任务<span class="badge badge-success">7</span></a></li>
                                <li class="divider"></li>
