                                                ...
                                                <div id="bs-example-navbar-collapse-2" class="collapse navbar-collapse">
                                                    <form role="search" class="navbar-form navbar-left" runat="server">
                                                        ...
                                                        &nbsp;
                                                            ...
                                                            <asp:Button ID="search" runat="server" Width="42" Height="30" BorderStyle="Dashed" ForeColor="#ffffff" BackColor=" #488c6c" BorderColor="#458567" Font-Size="12px" Text="查询"  />
                                                            <asp:Button ID="delete" runat="server" Width="42" Height="30" BorderStyle="Dashed" ForeColor="#ffffff" BackColor=" #488c6c" BorderColor="#458567" Font-Size="12px" Text="删除" />
                                                            <asp:Button ID="add" runat="server" Width="42" Height="30" BorderStyle="Dashed" ForeColor="#ffffff" BackColor=" #488c6c" BorderColor="#458567" Font-Size="12px" Text="增加" />
                                                            <asp:Button ID="update" runat="server" Width="42" Height="30" BorderStyle="Dashed" ForeColor="#ffffff" BackColor=" #488c6c" BorderColor="#458567" Font-Size="12px" Text="修改" />
